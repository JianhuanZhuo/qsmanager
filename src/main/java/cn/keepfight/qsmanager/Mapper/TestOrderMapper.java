...
import cn.keepfight.qsmanager.model.AnnualTotalModel;
import cn.keepfight.qsmanager.model.OrderModel;
 ...
 */
public interface TestOrderMapper extends Mapper{
    ...
    List<OperatorDao> selectAllTest() throws Exception;
