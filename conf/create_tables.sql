...
(
    ...
    year INT NOT NULL,
    remainder DECIMAL(10,5) DEFAULT 0 NOT NULL,
...
(
    ...
    billunit CHAR(64),
    billdate DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL,
    billtotal DECIMAL(10,5) DEFAULT 0 NOT NULL,
    rate DECIMAL(3,5) DEFAULT 0 NOT NULL,
    remitunit CHAR(64),
    pattern CHAR(32),
    remitdate DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL,
    paytotal DECIMAL(10,5) DEFAULT 0 NOT NULL,
    note VCHAR,
...
(
    ...
    rate DECIMAL(3,5) DEFAULT 0 NOT NULL,
    rebate DECIMAL(5,5) DEFAULT 0 NOT NULL,
    delifee DECIMAL(10,5) DEFAULT 0 NOT NULL,
    serial CHAR(32),
    name CHAR(32),
    detail CHAR(32),
...
(
    ...
    sid INTEGER NOT NULL,
    serial CHAR(32) NOT NULL,
    rdate DATETIME DEFAULT datetime('now', 'localtime') NOT NULL,
